...
def create_gif_from_video_with_face_blur(video_path, output_gif_path, start_time=4, duration=3, fps=None, resize_factor=0.6):
    """
    ...
    Args:
        ...
        resize_factor: Factor to resize frames (0.6 = 60% size)
    """
