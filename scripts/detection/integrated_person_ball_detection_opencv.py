...
class OpenCVFaceDetector:
    def __init__(self, confidence_threshold=0.5):
        ...
        Args:
            confidence_threshold: Detection confidence threshold (not used for Haar)
        """
...
class IntegratedPersonBallDetector:
    def __init__(self, model_path: str, support_img_path: str):
        """
        ...
        # Initialize face detector (OpenCV only)
        ...
        print(f"Face detection method: OpenCV Haar Cascade")
    ...
    def process_frame(self, frame: np.ndarray, blur_strength: int = 15) -> np.ndarray:
        """
        Process a single frame: detect and blur faces, detect and visualize ball.
...
def main():
    ...
    detector.process_video_segments(
        ...
        num_segments=5,       # 5 random segments
        blur_strength=15
    )
